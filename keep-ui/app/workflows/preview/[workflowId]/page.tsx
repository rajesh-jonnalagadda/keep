...
export default function PageWithId({ params }: { params: { workflowId: string } }) {
  ...
  return (
    <>
      {/* {workflowPreviewData?.workflow_raw  && workflowPreviewData.name === params.workflowId ? (
        <PageClient workflow={workflowPreviewData.workflow_raw} workflowId={params.workflowId} />
      ) 
      : (
        <p>Workflow not found</p>
      )} */}
      {!workflowPreviewData && <Loader />}
